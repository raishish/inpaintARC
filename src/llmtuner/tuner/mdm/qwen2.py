...
class ARCEmbedding(nn.Module):
    """Embedding layer for ARC grids.
    Supported embedding types:
        - ape: 2D absolute position embedding
        - 2d_rpe: 2D relative position embedding
        -
    """
