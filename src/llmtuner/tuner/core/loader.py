...
def load_model_and_tokenizer(
    ...
    if stage == 'sft':
        ...
        model.denoise_model = prepare_model_for_training(model=model.denoise_model, finetuning_args=finetuning_args) if is_trainable else model.denoise_model  # noqa: E501
